...
```
$ go get -d github.com/sourcegraph/monorepo-test-1/kubernetes-6
$ cd $GOPATH/src/github.com/sourcegraph/monorepo-test-1/kubernetes-6
$ make
```
...
[GoDoc]: https://godoc.org/github.com/sourcegraph/monorepo-test-1/kubernetes-6
[GoDoc Widget]: https://godoc.org/github.com/sourcegraph/monorepo-test-1/kubernetes-6?status.svg
