...
import (
	...
	v1alpha1 "github.com/sourcegraph/monorepo-test-1/kubernetes-13/pkg/apis/policy/v1alpha1"
)
...
// List lists all PodDisruptionBudgets in the indexer.
func (s *podDisruptionBudgetLister) List(selector labels.Selector) (ret []*v1alpha1.PodDisruptionBudget, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.PodDisruptionBudget))
	})
	return ret, err
}
...
// List lists all PodDisruptionBudgets in the indexer for a given namespace.
func (s podDisruptionBudgetNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.PodDisruptionBudget, err error) {
...
// Get retrieves the PodDisruptionBudget from the indexer for a given namespace and name.
func (s podDisruptionBudgetNamespaceLister) Get(name string) (*v1alpha1.PodDisruptionBudget, error) {
