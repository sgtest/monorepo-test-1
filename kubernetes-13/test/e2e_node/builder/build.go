...
func GetK8sRootDir() (string, error) {
	...
	if strings.Contains(path, "github.com/sourcegraph/monorepo-test-1/kubernetes-13") {
		splitPath := strings.Split(path, "github.com/sourcegraph/monorepo-test-1/kubernetes-13")
		return filepath.Join(splitPath[0], "github.com/sourcegraph/monorepo-test-1/kubernetes-13/"), nil
	}
