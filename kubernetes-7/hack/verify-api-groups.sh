...
prefix="${KUBE_ROOT%"github.com/sourcegraph/monorepo-test-1/kubernetes-7"}"
...
for register_file in "${register_files[@]}"; do
	...
	group_dirname="${package#"github.com/sourcegraph/monorepo-test-1/kubernetes-7/pkg/apis/"}"
...
packages_without_install=(
	"github.com/sourcegraph/monorepo-test-1/kubernetes-7/pkg/apis/abac"
)
known_version_files=(
