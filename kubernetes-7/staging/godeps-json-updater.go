...
// rewrites the Godeps.ImportPath, removes the Deps whose ImportPath contains "github.com/sourcegraph/monorepo-test-1/kubernetes-7" or "k8s.io/apimachinery".
...
func main() {
	...
	// removes the Deps whose ImportPath contains "github.com/sourcegraph/monorepo-test-1/kubernetes-7"
	i := 0
