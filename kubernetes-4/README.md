...
```
$ go get -d github.com/sourcegraph/monorepo-test-1/kubernetes-4
$ cd $GOPATH/src/github.com/sourcegraph/monorepo-test-1/kubernetes-4
$ make
```
...
[GoDoc]: https://godoc.org/github.com/sourcegraph/monorepo-test-1/kubernetes-4
[GoDoc Widget]: https://godoc.org/github.com/sourcegraph/monorepo-test-1/kubernetes-4?status.svg
