...
CLIENTSET="clientset"
MAIN_REPO_FROM_SRC="github.com/sourcegraph/monorepo-test-1/kubernetes-3"
...
echo "moving vendor/github.com/sourcegraph/monorepo-test-1/kubernetes-3"
cp -r "${CLIENT_REPO_TEMP}"/vendor/github.com/sourcegraph/monorepo-test-1/kubernetes-3/* "${CLIENT_REPO_TEMP}"/
...
go run "${KUBE_ROOT}/staging/godeps-json-updater.go" --godeps-file="${CLIENT_REPO_TEMP}/Godeps/Godeps.json" --override-import-path="${CLIENT_REPO_FROM_SRC}" --ignored-prefixes="k8s.io/client-go,github.com/sourcegraph/monorepo-test-1/kubernetes-3" --rewritten-prefixes="k8s.io/apimachinery"
