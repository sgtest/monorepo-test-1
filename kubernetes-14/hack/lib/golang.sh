...
readonly KUBE_GO_PACKAGE=github.com/sourcegraph/monorepo-test-1/kubernetes-14
...
kube::golang::build_binaries_for_platform() {
  ...
  for test in "${tests[@]:+${tests[@]}}"; do
    ...
    # doing a staleness check on github.com/sourcegraph/monorepo-test-1/kubernetes-14/test/e2e package always
