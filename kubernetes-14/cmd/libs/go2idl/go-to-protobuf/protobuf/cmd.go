...
func New() *Generator {
	...
	common := args.GeneratorArgs{
		...
		GoHeaderFilePath: filepath.Join(sourceTree, "github.com/sourcegraph/monorepo-test-1/kubernetes-14/hack/boilerplate/boilerplate.go.txt"),
	}
	...
	return &Generator{
		...
		Packages: strings.Join([]string{
			...
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/policy/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/extensions/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/autoscaling/v1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/authorization/v1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/autoscaling/v2alpha1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/authorization/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/batch/v1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/batch/v2alpha1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/apps/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/authentication/v1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/authentication/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/rbac/v1alpha1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/rbac/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/federation/apis/federation/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/certificates/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/imagepolicy/v1alpha1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/settings/v1alpha1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/storage/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-14/pkg/apis/storage/v1`,
		}, ","),
