...
type DeploymentCondition struct {
	...
	Status v1.ConditionStatus `json:"status" protobuf:"bytes,2,opt,name=status,casttype=github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/api/v1.ConditionStatus"`
...
type PodSecurityPolicySpec struct {
	...
	// +optional
	DefaultAddCapabilities []v1.Capability `json:"defaultAddCapabilities,omitempty" protobuf:"bytes,2,rep,name=defaultAddCapabilities,casttype=github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/api/v1.Capability"`
	// RequiredDropCapabilities are the capabilities that will be dropped from the container.  These
	// are required to be dropped and cannot be added.
	// +optional
	RequiredDropCapabilities []v1.Capability `json:"requiredDropCapabilities,omitempty" protobuf:"bytes,3,rep,name=requiredDropCapabilities,casttype=github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/api/v1.Capability"`
	// AllowedCapabilities is a list of capabilities that can be requested to add to the container.
	// Capabilities in this field may be added at the pod author's discretion.
	// You must not list a capability in both AllowedCapabilities and RequiredDropCapabilities.
	// +optional
	AllowedCapabilities []v1.Capability `json:"allowedCapabilities,omitempty" protobuf:"bytes,4,rep,name=allowedCapabilities,casttype=github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/api/v1.Capability"`
...
type NetworkPolicyPort struct {
	...
	// +optional
	Protocol *v1.Protocol `json:"protocol,omitempty" protobuf:"bytes,1,opt,name=protocol,casttype=github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/api/v1.Protocol"`
