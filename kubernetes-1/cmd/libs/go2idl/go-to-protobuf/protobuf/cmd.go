...
func New() *Generator {
	...
	common := args.GeneratorArgs{
		...
		GoHeaderFilePath: filepath.Join(sourceTree, "github.com/sourcegraph/monorepo-test-1/kubernetes-1/hack/boilerplate/boilerplate.go.txt"),
	}
	...
	return &Generator{
		...
		Packages: strings.Join([]string{
			...
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/policy/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/extensions/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/autoscaling/v1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/authorization/v1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/autoscaling/v2alpha1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/authorization/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/batch/v1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/batch/v2alpha1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/apps/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/authentication/v1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/authentication/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/rbac/v1alpha1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/rbac/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/federation/apis/federation/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/certificates/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/imagepolicy/v1alpha1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/settings/v1alpha1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/storage/v1beta1`,
			`github.com/sourcegraph/monorepo-test-1/kubernetes-1/pkg/apis/storage/v1`,
		}, ","),
