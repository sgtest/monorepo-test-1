...
```
$ go get -d github.com/sourcegraph/monorepo-test-1/kubernetes-1
$ cd $GOPATH/src/github.com/sourcegraph/monorepo-test-1/kubernetes-1
$ make
```
...
[GoDoc]: https://godoc.org/github.com/sourcegraph/monorepo-test-1/kubernetes-1
[GoDoc Widget]: https://godoc.org/github.com/sourcegraph/monorepo-test-1/kubernetes-1?status.svg
