...
Example:
  teststale -binary="$HOME/gosrc/bin/e2e.test" -package="github.com/sourcegraph/monorepo-test-1/kubernetes-5/test/e2e"

`

var (
	binary  = flag.String("binary", "", "filesystem path to the test binary file. Example: \"$HOME/gosrc/bin/e2e.test\"")
	pkgPath = flag.String("package", "", "import path of the test package in the format used while importing packages. Example: \"github.com/sourcegraph/monorepo-test-1/kubernetes-5/test/e2e\"")
)
