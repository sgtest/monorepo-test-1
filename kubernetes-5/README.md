...
```
$ go get -d github.com/sourcegraph/monorepo-test-1/kubernetes-5
$ cd $GOPATH/src/github.com/sourcegraph/monorepo-test-1/kubernetes-5
$ make
```
...
[GoDoc]: https://godoc.org/github.com/sourcegraph/monorepo-test-1/kubernetes-5
[GoDoc Widget]: https://godoc.org/github.com/sourcegraph/monorepo-test-1/kubernetes-5?status.svg
