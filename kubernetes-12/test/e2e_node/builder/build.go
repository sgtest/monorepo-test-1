...
func GetK8sRootDir() (string, error) {
	...
	if strings.Contains(path, "github.com/sourcegraph/monorepo-test-1/kubernetes-12") {
		splitPath := strings.Split(path, "github.com/sourcegraph/monorepo-test-1/kubernetes-12")
		return filepath.Join(splitPath[0], "github.com/sourcegraph/monorepo-test-1/kubernetes-12/"), nil
	}
