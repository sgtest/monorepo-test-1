...
```
$ go get -d github.com/sourcegraph/monorepo-test-1/kubernetes-9
$ cd $GOPATH/src/github.com/sourcegraph/monorepo-test-1/kubernetes-9
$ make
```
...
[GoDoc]: https://godoc.org/github.com/sourcegraph/monorepo-test-1/kubernetes-9
[GoDoc Widget]: https://godoc.org/github.com/sourcegraph/monorepo-test-1/kubernetes-9?status.svg
