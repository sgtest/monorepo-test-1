...
```
$ go get -d github.com/sourcegraph/monorepo-test-1/kubernetes-8
$ cd $GOPATH/src/github.com/sourcegraph/monorepo-test-1/kubernetes-8
$ make
```
...
[GoDoc]: https://godoc.org/github.com/sourcegraph/monorepo-test-1/kubernetes-8
[GoDoc Widget]: https://godoc.org/github.com/sourcegraph/monorepo-test-1/kubernetes-8?status.svg
