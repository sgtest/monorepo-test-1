...
LISTERGEN_APIS=(${LISTERGEN_APIS[@]/#/github.com/sourcegraph/monorepo-test-1/kubernetes-8/})
...
INFORMERGEN_APIS=(${INFORMERGEN_APIS[@]/#/github.com/sourcegraph/monorepo-test-1/kubernetes-8/})
INFORMERGEN_APIS=$(IFS=,; echo "${INFORMERGEN_APIS[*]}")
${informergen} \
  --input-dirs "${INFORMERGEN_APIS}" \
  --versioned-clientset-package github.com/sourcegraph/monorepo-test-1/kubernetes-8/pkg/client/clientset_generated/clientset \
  --internal-clientset-package github.com/sourcegraph/monorepo-test-1/kubernetes-8/pkg/client/clientset_generated/internalclientset \
  --listers-package github.com/sourcegraph/monorepo-test-1/kubernetes-8/pkg/client/listers \
  "$@"
