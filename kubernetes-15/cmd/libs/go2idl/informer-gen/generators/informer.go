...
func (g *informerGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	//listerPackage := "github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/client/listers/" + g.groupVersion.Group.NonEmpty() + "/" + strings.ToLower(g.groupVersion.Version.NonEmpty())
