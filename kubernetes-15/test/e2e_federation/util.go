...
import (
	...
	"github.com/sourcegraph/monorepo-test-1/kubernetes-15/test/e2e/common"
	"github.com/sourcegraph/monorepo-test-1/kubernetes-15/test/e2e/framework"
	fedframework "github.com/sourcegraph/monorepo-test-1/kubernetes-15/test/e2e_federation/framework"
...
var (
	...
	DNSTTL = 180 * time.Second // TODO: make github.com/sourcegraph/monorepo-test-1/kubernetes-15/federation/pkg/federation-controller/service.minDnsTtl exported, and import it here.
)
