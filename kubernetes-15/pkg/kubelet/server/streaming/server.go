...
type Config struct {
	...
	// github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/kubelet/server/remotecommand/constants.go for available protocols.
	// Only used for SPDY streaming.
	SupportedRemoteCommandProtocols []string

	// The streaming protocols the server supports (understands and permits).  See
	// github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/kubelet/server/portforward/constants.go for available protocols.
	// Only used for SPDY streaming.
