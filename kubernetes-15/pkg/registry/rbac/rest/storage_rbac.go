...
import (
	...
	rbacapiv1alpha1 "github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/apis/rbac/v1alpha1"
	rbacapiv1beta1 "github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/apis/rbac/v1beta1"
	rbacclient "github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/client/clientset_generated/internalclientset/typed/rbac/internalversion"
	"github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/client/retry"
	"github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/registry/rbac/clusterrole"
	clusterrolepolicybased "github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/registry/rbac/clusterrole/policybased"
	clusterrolestore "github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/registry/rbac/clusterrole/storage"
	"github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/registry/rbac/clusterrolebinding"
	clusterrolebindingpolicybased "github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/registry/rbac/clusterrolebinding/policybased"
	clusterrolebindingstore "github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/registry/rbac/clusterrolebinding/storage"
	"github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/registry/rbac/reconciliation"
	"github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/registry/rbac/role"
	rolepolicybased "github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/registry/rbac/role/policybased"
	rolestore "github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/registry/rbac/role/storage"
	"github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/registry/rbac/rolebinding"
	rolebindingpolicybased "github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/registry/rbac/rolebinding/policybased"
	rolebindingstore "github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/registry/rbac/rolebinding/storage"
	rbacregistryvalidation "github.com/sourcegraph/monorepo-test-1/kubernetes-15/pkg/registry/rbac/validation"
	"github.com/sourcegraph/monorepo-test-1/kubernetes-15/plugin/pkg/auth/authorizer/rbac/bootstrappolicy"
)
