...
// rewrites the Godeps.ImportPath, removes the Deps whose ImportPath contains "github.com/sourcegraph/monorepo-test-1/kubernetes-10" or "k8s.io/apimachinery".
...
func main() {
	...
	// removes the Deps whose ImportPath contains "github.com/sourcegraph/monorepo-test-1/kubernetes-10"
	i := 0
