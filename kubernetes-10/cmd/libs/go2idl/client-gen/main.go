...
import (
	...
	"k8s.io/gengo/args"
	clientgenargs "github.com/sourcegraph/monorepo-test-1/kubernetes-10/cmd/libs/go2idl/client-gen/args"
	"github.com/sourcegraph/monorepo-test-1/kubernetes-10/cmd/libs/go2idl/client-gen/generators"
	"github.com/sourcegraph/monorepo-test-1/kubernetes-10/cmd/libs/go2idl/client-gen/types"
...
var (
	...
	basePath               = flag.String("input-base", "github.com/sourcegraph/monorepo-test-1/kubernetes-10/pkg/apis", "base path to look for the api group.")
	...
	clientsetPath          = flag.String("clientset-path", "github.com/sourcegraph/monorepo-test-1/kubernetes-10/pkg/client/clientset_generated/", "the generated clientset will be output to <clientset-path>/<clientset-name>.")
...
func main() {
	...
	arguments.GoHeaderFilePath = filepath.Join(args.DefaultSourceTree(), "github.com/sourcegraph/monorepo-test-1/kubernetes-10/hack/boilerplate/boilerplate.go.txt")
	flag.Parse()
	var cmdArgs string
	...
	if *test {
		arguments.InputDirs = append(dependencies, []string{
			"github.com/sourcegraph/monorepo-test-1/kubernetes-10/cmd/libs/go2idl/client-gen/test_apis/testgroup",
		}...)
		arguments.CustomArgs = clientgenargs.Args{
			...
			GroupVersionToInputPath: map[types.GroupVersion]string{
				{Group: "testgroup", Version: ""}: "github.com/sourcegraph/monorepo-test-1/kubernetes-10/cmd/libs/go2idl/client-gen/test_apis/testgroup",
			},
			ClientsetName:       "test_internalclientset",
			ClientsetOutputPath: "github.com/sourcegraph/monorepo-test-1/kubernetes-10/cmd/libs/go2idl/client-gen/testoutput/clientset_generated/",
			ClientsetOnly:       false,
			FakeClient:          true,
			CmdArgs:             cmdArgs,
		}
