...
var (
	apiScheme                   = types.Name{Package: "github.com/sourcegraph/monorepo-test-1/kubernetes-2/pkg/api", Name: "Scheme"}
	...
	listOptions                 = types.Name{Package: "github.com/sourcegraph/monorepo-test-1/kubernetes-2/pkg/api", Name: "ListOptions"}
