...
// (You must first `go install github.com/sourcegraph/monorepo-test-1/kubernetes-2/cmd/libs/go2idl/set-gen`)
package types

//go:generate set-gen -i github.com/sourcegraph/monorepo-test-1/kubernetes-2/pkg/util/sets/types
